       ...
       <div className="w-full mb-4">
            <div className="flex items-center justify-between border">
                <div className="py-2 bg-white rounded-b-lg w-full">
                    ...
                    <textarea id="editor" onChange={onChange} rows={8} className="pl-2 block w-full px-0 text-sm text-gray-800 bg-white border-0 focus:outline-none focus:ring-0" placeholder="Write an article..." required />
                </div>
            </div>    
        </div>
    </div>    
